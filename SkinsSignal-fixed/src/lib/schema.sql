...
-- Indices
CREATE INDEX IF NOT EXISTS idx_snapshots_user_time ON inventory_snapshots(user_id, taken_at);
CREATE INDEX IF NOT EXISTS idx_items_snapshot ON item_snapshots(snapshot_id);
CREATE INDEX IF NOT EXISTS idx_overrides_user_item ON item_overrides(user_id, item_name);
CREATE INDEX IF NOT EXISTS idx_alerts_user_item ON alerts(user_id, item_name);
CREATE INDEX IF NOT EXISTS idx_alert_events_alert_time ON alert_events(alert_id, fired_at);
